...
export function Search() {
    ...
    function showandremove() {
        ...
        // return <div
        //     className="flex p-4 mb-4 text-sm text-red-700 border border-red-700 rounded-lg bg-white shadow shadow-2xl shadow-black"
        //     role="alert">
        ...
        return <div id="toast-danger"
                    ...
                    role="alert">
            <div className="text-sm font-normal">Not Found</div>
    ...
    return (
        <div>
            <div className='flex flex-col items-center'>
                <div>{notfound ? showandremove() : <p></p>}</div>
                <div>{loading ? showloading() : <p></p>}</div>
